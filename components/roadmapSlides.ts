...
export const roadmapSlides: RoadmapSlideData[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { title: 'Тестирование', items: ['Работа с Jest / Vitest', 'Покрытие редьюсера тестами', 'Test Driven Development (TDD)', 'Playwright'], x: 700, y: 105, w: 400, accent: '#46ba4c', side: 'left', accentLength: 205 },
      { title: 'Взаимодействие с сервером', items: ['Запросы к серверу (Ajax Request) с Axios', 'Работа с REST API', 'Реализация CRUD операций', 'Типизация запросов и использование "дженериков"'], x: 1200, y: 835, w: 540, accent: '#5b2be4', side: 'left', accentDirection: 'up', accentLength: 50 },
      { title: 'WebSocket', items: ['Постоянное соединение клиента и сервера', 'Передача данных в реальном времени без задержек'], x: 1420, y: 200, w: 300, accent: '#131414', side: 'right', accentLength: 135 },
    ],
  },
  {
    id: 5,
    ...
    icons: [
      { label: 'Errors', x: 205, y: 305, color: '#d11031' },
      { label: 'React Hook Form + Zod', x: 865, y: 385, color: '#ec4c8a' },
      { label: 'Login', x: 1668, y: 655, color: '#0e3a50' },
    ],
    blocks: [
      { title: 'Обработка ошибок / loaders', items: ['Preloaders (отображение на UI)', 'Disable кнопок и компонент, как часть правильного UX', 'Обработка ошибок'], x: 275, y: 750, w: 440, accent: '#d11031', side: 'left', accentDirection: 'up', accentLength: 145 },
      { title: 'React hook form', items: ['Получение данных', 'Валидация и обработка ошибок', 'Валидация форм и ответа сервера с Zod'], x: 925, y: 700, w: 420, accent: '#ec4c8a', side: 'left', accentDirection: 'up', accentLength: 70 },
      { title: 'Auth flow', items: ['Axios interceptors', 'Protected routes', 'Реализация авторизационного Flow (login, logout, authMe)'], x: 1440, y: 340, w: 310, accent: '#0e3a50', side: 'right', accentLength: 125 },
    ],
  },
  {
    id: 6,
