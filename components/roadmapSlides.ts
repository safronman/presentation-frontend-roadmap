...
export const roadmapSlides: RoadmapSlideData[] = [
  {
    ...
    avatar: '👶',
    avatarColor: '#ccfb50',
    path: 'M -40 535 C 260 420, 390 735, 670 675 S 1080 420, 1325 360 S 1610 390, 1960 425',
    icons: [
  ...
  },
  {
    ...
    avatar: '👦',
    avatarColor: '#5bc7e7',
    path: 'M -40 470 C 210 350, 240 585, 510 555 S 780 840, 980 610 S 1280 440, 1370 610 S 1650 595, 1960 720',
    icons: [
  ...
  {
    id: 10,
    path: 'M -40 540 C 150 685, 270 855, 450 830 S 690 560, 860 535 S 1110 300, 1270 300 S 1690 330, 1960 595',
    icons: [
