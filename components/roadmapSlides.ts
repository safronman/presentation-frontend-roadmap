...
export const roadmapSlides: RoadmapSlideData[] = [
  {
    ...
    icons: [
      {label: 'Start', icon: 'fluent:rocket-16-regular', x: 90, y: 400, w: 300, h: 300, kind: 'badge', color: '#b7df6a', iconColor: '#050505',},
  ...
  },
  {
    ...
    icons: [
      ...
      {label: 'Finish', icon: 'ph:flag-checkered', x: 1573, y: 400, w: 300, h: 300, kind: 'badge', color: '#b7df6a', iconColor: '#050505',},
    ],
    blocks: [
      {
